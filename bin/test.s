...
main:
  ...
  mov	DWORD PTR [rbp - 138], 0
L0:
  mov	ebx, DWORD PTR [rbp - 138]
  cmp	ebx, DWORD PTR [rbp - 134]
  setl	al
  movzx	eax, al
  test	eax, eax
  je	L1
  mov	eax, DWORD PTR [rbp - 138]
  imul	eax, 13
  movsx	rbx, eax
  lea	rax, [rbp - 130]
  add	rax, rbx
...
L2:
  mov	eax, DWORD PTR [rbp - 138]
  add	DWORD PTR [rbp - 138], 1
  jmp	L0
L1:
  mov	DWORD PTR [rbp - 142], 0
L3:
  mov	ebx, DWORD PTR [rbp - 142]
  cmp	ebx, DWORD PTR [rbp - 134]
  setl	al
  movzx	eax, al
  test	eax, eax
  je	L4
  mov	eax, DWORD PTR [rbp - 142]
  imul	eax, 13
  movsx	rbx, eax
  lea	rax, [rbp - 130]
  add	rax, rbx
